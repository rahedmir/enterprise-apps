...
{
    public partial class frm_domain_support_asset_laptop : Form
    {
        public frm_domain_support_asset_laptop()
        {
            InitializeComponent();
        }
        ...
        private void frm_domain_support_asset_laptop_Load(object sender, EventArgs e)
        {
            txtYear.Text = "";
            txtNum.Text = "";
            ...
            else if (checkValue == 1)
            {
                ...
                else
                {
                    ...
                    if (isMatch)
                    {
                        if (num.Length == 8)
                        {
                            SetHostName($"IBI{txtYear.Text}TIF{txtNum.Text}");
                        }
                        else
                        {
